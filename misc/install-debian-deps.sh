...
highcitdh_deps="dh-python python3-build python3-setuptools python3-venv python3-wheel python3-pip python3-all-dev flit fakeroot gcc clang git make"
...
# FIXME: we need to make vula_libnss build a deb without stdeb
